...
export default class App extends Component {
  ...
  changeValueHandler = () => {
    if (this.state.airHightTemp == null) {
      ...
      this.state.airHightTemp < 20 ||
      this.state.airHightTemp > 40 ||
      this.state.airLowerTemp < 20 ||
      this.state.airLowerTemp > 40
    ) {
      ...
      this.setState(
        ...
        () => {
          this.props.currentTemp(this.state.airHightTemp),
            this.props.setTemp(this.state.airLowerTemp);
        },
      );
    }
  };
  ...
  runFunction = () => {
    console.log('kya aya high me', this.state.airHightTemp);
    console.log('kya aya lower me', this.state.airLowerTemp);
    this.props.currentTemp(this.state.airHightTemp);
    this.props.setTemp(this.state.airLowerTemp);
  };
    ...
    return (
      <View>
        <TouchableOpacity style={style.listView} onPress={this.toggleAir}>
          <Text style={style.listText}>Air Temperature</Text>
              ...
              <View style={style.modalContainerInner}>
                <View style={style.headerContainer}>
                  <View style={style.headerInner}>
                    ...
                    <Text style={style.headerHeading}>Air Temperature</Text>
                  </View>
                </View>
                <View style={style.bodyContainer}>
                  <View style={style.bodyInner}>
                    <Text style={style.currentHeading}>Higher Temperature</Text>
                    {/* <TextInput
                    ...
                    <Text style={style.currentHeading}>Lower Temperature</Text>
                    <NumericInput
